...
import com.epam.todo.entity.dto.CaptchaResponseDto;
...
public class RegistrationController {
    ...
    public String addUser(
            @RequestParam("secondPassword") String passwordConfirmation,
        ...
        if (isConfirmationEmpty){
            model.addAttribute("secondPasswordError", "Password confirmation cannot be empty");
        }
